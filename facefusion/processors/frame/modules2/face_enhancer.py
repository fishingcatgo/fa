...
def process_video(source_path : str, temp_frame_paths : List[str]) -> None:
	facefusion.processors.frame.core2.multi_process_frames(None, temp_frame_paths, process_frames)
...
def process_video23(source_path : str, temp_frame_paths : List[str]) -> None:
	facefusion.processors.frame.core2.multi_process_frames(None, temp_frame_paths, process_frames23)
